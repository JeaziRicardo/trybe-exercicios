...
import * as Exercise from './fixacao';
...
console.log(`Losango com D = 75cm e d = 25cm: ${Exercise.rhombus(75, 25)}cm²`);

console.log(`Trapézio com B = 100cm, b = 70cm e altura = 50cm: ${Exercise.trapeze(50, 100, 70)}cm²`);
console.log(`Trapézio com B = 75cm, b = 50cm e altura = 35cm: ${Exercise.trapeze(35, 75, 50)}cm²`);
console.log(`Trapézio com B = 150cm, b = 120cm e altura = 80cm: ${Exercise.trapeze(85, 150, 120)}cm²`);
