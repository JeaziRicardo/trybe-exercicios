...
// R - A propriedade do CSS "Transform" aplicada na classe tech, está movimentando a "caixa verde" em -20px na vertical (eixo Y).
...
myWebpage.addEventListener('dblclick', function() {
  window.open('https://jeaziricardo.github.io');
});
